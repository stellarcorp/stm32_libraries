...
@par Hardware and Software environment
 ...
 4 - Run the demonstration
  ...
  - This Demonstration has been tested with STM32L496G-DISCO board (MB1261-revB01) and can be
    easily tailored to any other supported device and development board.

  - For the STM32L496G-DISCO board REV06 (MB1261-revB06) a specific demonstration is available under 
    "\Projects\32L496GDISCOVERY\Demonstrations\Binary\32L496GDISCOVERY_REVB06" in binary format supporting 
    the new hardware touchscreen component ft3x67.

  - Binary file STM32CubeDemo_STM32L496G-Discovery-MB1261-B01_V1.0.2.hex is released within a 
   separate package that is available for download from this Link: https://www.st.com/resource/en/compiled_demos/32l496gdiscovery_demo.zip

  - The binary file is available under "32l496gdiscovery_demo/binary" directory and can be downloaded using STM32CubeProgrammer tool.
